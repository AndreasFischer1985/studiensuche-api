...
from deutschland.studiensuche import rest
...
from deutschland.studiensuche.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.studiensuche  # this is an instance of the class Endpoint
        api_instance.studiensuche()  # this invokes api_instance.studiensuche.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.studiensuche.callable or self.callable in this class
